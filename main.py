# CODED BY SAN 
# HELLO GUYS THIS CODE IS WRITTEN BY ME PLEASE DONT COPY
...
stderr.writelines(f"""{Gr}
   _____  ___  __   _________  ___  _______ __
  / __/ |/_/ |/ /__/_  __/ _ \/ _ |/ ___/ //_/
 _\ \_>  </    /___// / / , _/ __ / /__/ ,<   
/___/_/|_/_/|_/    /_/ /_/|_/_/ |_\___/_/|_|  
                                              
          {Wh}[ + ]  C O D E   B Y  S A N  [ + ]  
...
if input_user == '1': #OPSI 1
    ...
    stderr.writelines(f"""{Wh}
     .-.
   .'   `.          {Wh}--------------------------------
   :g g   :         {Wh}| {Gr}S A N - TRACKER - IP ADDRESS {Wh}|
   : o    `.        {Wh}|       {Gr}@CODE BY SAN           {Wh}|
  :         ``.     {Wh}--------------------------------
 :             `.
:  :         .   `.
:   :          ` . `.
 `.. :            `. ``;
    ...
    stderr.writelines(f"""{Wh}
     .-.
   .'   `.          {Wh}----------------------------------
   :g g   :         {Wh}| {Gr}S A N - TRACKER - PHONE NUMBER {Wh}|
   : o    `.        {Wh}|        {Gr}@CODE BY SAN            {Wh}|
  :         ``.     {Wh}----------------------------------
 :             `.
:  :         .   `.
:   :          ` . `.
 `.. :            `. ``;
    ...
    try:
        def phoneGW():
            User_phone = input(f"\n {Wh}Enter phone number target {Gr}Ex [+9181xxxxxxxxx] {Wh}: {Gr}") #INPUT NUMBER PHONE
    ...
    stderr.writelines(f"""{Wh}
     .-.
   .'   `.          {Wh}----------------------------------
   :g g   :         {Wh}|  {Gr}S A N - SHOW YOUR IP ADDRESS  {Wh}|
   : o    `.        {Wh}|        {Gr}@CODE BY SAN       {Wh}|
  :         ``.     {Wh}----------------------------------
 :             `.
:  :         .   `.
...
""")
    ...
    stderr.writelines(f"""{Wh}
     .-.
   .'   `.          {Wh}----------------------------------
   :g g   :         {Wh}|    {Gr}S A N - TRACKER USERNAME    {Wh}|
   : o    `.        {Wh}|        {Gr}@CODE BY SAN            {Wh}|
  :         ``.     {Wh}----------------------------------
 :             `.
:  :         .   `.
